    ...
    public static void main(String[] args) {
        try (Connection connection = DatabaseConnection.getConnection(); Statement statement = connection.createStatement()) {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                String insertAccount = String.format("INSERT INTO Account (UserID, AccountNumber, Balance) VALUES (%d, 'ACC%d', %f)", i, 1000 + i, 1000.0 * i);
                statement.executeUpdate(insertAccount);

                String insertTransaction = String.format("INSERT INTO Transaction (AccountID, TransactionType, Amount, Date) VALUES (%d, 'Deposit', %f, NOW())", i, 100.0 * i);
